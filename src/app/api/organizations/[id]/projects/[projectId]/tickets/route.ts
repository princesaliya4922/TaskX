...
// GET /api/organizations/[id]/projects/[projectId]/tickets - Get project tickets
export async function GET(
  ...
  try {
    ...
    if (sprintId) {
      if (sprintId === "null") {
        where.sprintId = null; // Get tickets not in any sprint (backlog)
      } else {
...
// POST /api/organizations/[id]/projects/[projectId]/tickets - Create project ticket
